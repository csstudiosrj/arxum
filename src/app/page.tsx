  ...
  return (
    <main className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      <div className="text-center space-y-8 max-w-4xl">
        ...
        <h1
          className="text-6xl md:text-7xl font-bold tracking-tight arxum-logo-shine"
          style={{
        ...
        <nav className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 justify-center mt-10 w-full">
          ...
          <a
            href="/suite"
            className="group bg-gray-900 hover:bg-gray-800 border border-gray-800 hover:border-red-900 rounded-xl p-5 transition-all text-left"
          >
          ...
          <a
            href="/fest"
            className="group bg-gray-900 hover:bg-gray-800 border border-gray-800 hover:border-yellow-700 rounded-xl p-5 transition-all text-left"
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-lg bg-yellow-950 border border-yellow-800 flex items-center justify-center">
          ...
          <a
            href="/crew"
            className="group bg-gray-900 hover:bg-gray-800 border border-gray-800 hover:border-violet-900 rounded-xl p-5 transition-all text-left"
          >
            <div className="flex items-center gap-3 mb-3">
          ...
          <a
            href="/calculadoras"
            className="group bg-gray-900 hover:bg-gray-800 border border-gray-800 hover:border-green-900 rounded-xl p-5 transition-all text-left"
          >
            <div className="flex items-center gap-3 mb-3">
          ...
          <a
            href="/poseidon"
            className="group bg-gray-900 hover:bg-gray-800 border border-gray-800 hover:border-cyan-900 rounded-xl p-5 transition-all text-left"
          >
            <div className="flex items-center gap-3 mb-3">
          ...
          <a
            href="/descomplicai"
            className="group bg-gray-900 hover:bg-gray-800 border border-gray-800 hover:border-amber-900 rounded-xl p-5 transition-all text-left"
          >
            <div className="flex items-center gap-3 mb-3">
